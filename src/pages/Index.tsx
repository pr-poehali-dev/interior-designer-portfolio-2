...
const reviews = [
  { name: "Евгения", text: "Людмила не только мастер своего дела, но ещё и хороший психолог. Она обладает редким сочетанием высокой квалификации и чуткого, внимательного отношения к клиентам. Изменила жуткую квартиру в игрушку, куда хочется приходить жить. Настоятельно рекомендую дизайнера с большой буквы.", role: "Клиент, Telegram", img: "https://cdn.poehali.dev/projects/6c550c2e-7d02-4220-9f88-3d3e5d45fc42/bucket/df9da9eb-3534-4832-a58a-c0a65f9bc619.jpg" },
  { name: "Илона Васильевна", text: "Благодаря вашей работе у нас не возникло трудностей в решении даже самых малейших вопросов: от прокладки кабелей до цветовых решений в интерьере. Очень благодарны с мужем за Ваш труд. Если вдруг назреет ремонт ещё, то только с Вами!", role: "Клиент, Telegram", img: "https://cdn.poehali.dev/projects/6c550c2e-7d02-4220-9f88-3d3e5d45fc42/bucket/564b2a68-8f36-478e-87ba-c24349e49747.jpg" },
  { name: "Илона Васильевна", text: "Вот прям аналогично, аж прослезилась — что мы смогли, какая картинка получилась! Но реально это всё помогла ваша работа, иначе мы б не осилили! Спасибо огромное от нас двоих!", role: "Клиент, Telegram", img: "https://cdn.poehali.dev/projects/6c550c2e-7d02-4220-9f88-3d3e5d45fc42/bucket/5ff797cb-ddf2-452e-8388-4467f0d06c40.jpg" },
];
    ...
    <div style={{ backgroundColor: "#0f0d0b", color: "#e8dcc8", minHeight: "100vh" }}>
      ...
      <section id="hero" style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "flex-end", paddingBottom: "8vh", overflow: "hidden" }}>
        ...
        <div className="fade-in-up delay-5 hidden md:flex" style={{ position: "absolute", bottom: "2.5rem", right: "2rem", gap: "2.5rem" }}>
          {[["5+", "лет опыта"], ["20+", "проектов"]].map(([num, label]) => (
      ...
      <section id="about" style={{ padding: "6rem 2rem", borderTop: "1px solid rgba(201,169,110,0.1)" }} className="md:px-16 lg:px-24">
        <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "4rem", alignItems: "center" }} className="lg:grid-cols-2">
          <div className="reveal" style={{ position: "relative", display: "grid", gridTemplateColumns: "1fr 1fr", gridTemplateRows: "auto auto", gap: "0.75rem" }}>
            ...
            <div style={{ gridColumn: "2", gridRow: "1", overflow: "hidden" }}>
              <img
                ...
                alt="Людмила Соколова"
                style={{ width: "100%", height: "400px", objectFit: "contain", objectPosition: "center center", background: "#1a1714", display: "block", transition: "transform 0.7s ease" }}
                onMouseEnter={e => ((e.currentTarget as HTMLImageElement).style.transform = "scale(1.04)")}
                onMouseLeave={e => ((e.currentTarget as HTMLImageElement).style.transform = "scale(1)")}
              />
            </div>
          ...
          <div className="reveal">
            ...
            <div style={{ fontFamily: "'Golos Text', sans-serif", fontWeight: 300, fontSize: "0.93rem", color: "rgba(232,220,200,0.45)", lineHeight: 2, marginBottom: "2.5rem" }}>
              <div style={{ marginBottom: "0.6rem" }}>Образование:</div>
              {[
                ...
                <div key={i} style={{ display: "flex", gap: "0.6rem", marginBottom: "0.3rem" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5rem" }}>
              {[["Жилых проектов", "20+"]].map(([label, val]) => (
          ...
          <div style={{ position: "relative", minHeight: "200px" }}>
            {reviews.map((review, idx) => (
              <div key={idx} style={{ position: idx === activeReview ? "relative" : "absolute", top: 0, left: 0, right: 0, opacity: idx === activeReview ? 1 : 0, transition: "opacity 0.7s ease", pointerEvents: idx === activeReview ? "auto" : "none" }}>
                <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(1.1rem, 2.2vw, 1.6rem)", fontStyle: "italic", fontWeight: 300, color: "#e8dcc8", lineHeight: 1.7, textAlign: "center", marginBottom: "2rem" }}>
                  «{review.text}»
                </p>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "1rem", marginBottom: review.img ? "1.8rem" : 0 }}>
                  <div style={{ width: 28, height: 1, background: "#c9a96e" }} />
                  <div>
                ...
                {review.img && (
                  <div style={{ display: "flex", justifyContent: "center" }}>
                    <img src={review.img} alt={`Отзыв от ${review.name}`}
                      style={{ maxWidth: "360px", width: "100%", borderRadius: "4px", border: "1px solid rgba(201,169,110,0.15)", opacity: 0.9 }} />
                  </div>
                )}
              </div>
            ))}
